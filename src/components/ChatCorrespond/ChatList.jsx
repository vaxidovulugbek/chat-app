  ...
  return (
    ...
    <div className='ChatList'>
        <div className='ChatList__menu'>
           {/* <Button className='ChatList__menu-open'><img className='ChatList__menu-user-pic' src="https://upload.wikimedia.org/wikipedia/commons/9/9a/Gull_portrait_ca_usa.jpg" alt="user" /></Button> */}
